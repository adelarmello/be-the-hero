...
export default function Profile(){
  ...
  async function handleDeleteIncident(id){
    try{
        ...
        setIncidents(incidents.filter(incident => incident.id !== id)) //Mostra os incidentes que não foram deletados. Ou seja, Atualiza a pág qunado clicar no botão de deletar
    }catch(error){
